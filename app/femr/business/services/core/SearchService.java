...
public class SearchService implements ISearchService {
    ...
    private final IIPatientItemModelMapper patientItemModelMapper;
    ...
    private final IPrescriptionItemModelMapper prescriptionItemModelMapper;
    ...
    public SearchService(IRepository<IConceptDiagnosis> diagnosisRepository,
                         ...
                         IIPatientItemModelMapper patientItemModelMapper,
                         IPrescriptionItemModelMapper prescriptionItemModelMapper,
        ...
        this.patientItemModelMapper=patientItemModelMapper;
        this.prescriptionItemModelMapper=prescriptionItemModelMapper;
    }
    ...
    public ServiceResponse<PatientItem> retrievePatientItemByPatientId(int patientId) {
        ...
        try {
            ...
            PatientItem patientItem = patientItemModelMapper.createPatientItem(
                    savedPatient.getId(),
            ...
            if (isMetric()){
                patientItem =  SearchServiceLocaleUnitConverter.toMetric(patientItem);
            }else {
               //added for femr-136 - dual unit display
                patientItem =SearchServiceLocaleUnitConverter.forDualUnitDisplay(patientItem);
            }
    ...
    public ServiceResponse<PatientEncounterItem> retrievePatientEncounterItemByEncounterId(int encounterId) {
        ...
        try {
            IPatientEncounter patientEncounter = patientEncounterRepository.findOne(patientEncounterQuery);
            PatientEncounterItem patientEncounterItem = patientItemModelMapper.createPatientEncounterItem(patientEncounter);
    ...
    public ServiceResponse<PatientEncounterItem> retrieveRecentPatientEncounterItemByPatientId(int patientId) {
        ...
        try {
            ...
            PatientEncounterItem patientEncounterItem = patientItemModelMapper.createPatientEncounterItem(currentPatientEncounter);
            response.setResponseObject(patientEncounterItem);
    ...
    public ServiceResponse<List<PatientEncounterItem>> retrievePatientEncounterItemsByPatientId(int patientId) {
        ...
        try {
            ...
            for (IPatientEncounter pe : patientEncounters) {
                patientEncounterItems.add(patientItemModelMapper.createPatientEncounterItem(pe));
            }
    ...
    public ServiceResponse<List<PrescriptionItem>> retrieveUnreplacedPrescriptionItems(int encounterId) {
        ...
        try {
            ...
            for( IPatientPrescription pp : patientPrescriptions )
            {
                ...
                PrescriptionItem item = prescriptionItemModelMapper.createPrescriptionItem(
    ...
    public ServiceResponse<List<PrescriptionItem>> retrieveDispensedPrescriptionItems(int encounterId) {
        ...
        try {
            ...
            List<PrescriptionItem> prescriptionItems = patientPrescriptions.stream()
                    ...
                    .map(pp -> prescriptionItemModelMapper.createPrescriptionItem(
                            pp.getId(),
                            pp.getMedication().getName(),
                            null,
                            pp.getPhysician().getFirstName(),
    ...
    public ServiceResponse<List<PatientItem>> retrievePatientsFromQueryString(String patientSearchQuery) {
        ...
        try {
            ...
            for (IPatient patient : patients) {
                ...
                patientItems.add(patientItemModelMapper.createPatientItem(
                        patient.getId(),
                        patient.getFirstName(),
                        patient.getLastName(),
                        patient.getCity(),
    ...
    public ServiceResponse<List<PatientItem>> retrievePatientsForSearch(Integer tripId) {
        ...
        try {
            ...
            for (IPatient patient : allPatients) {
                ...
                PatientItem currPatient = patientItemModelMapper.createPatientItem(
                        patient.getId(),
                        patient.getFirstName(),
                        patient.getLastName(),
                        patient.getCity(),
