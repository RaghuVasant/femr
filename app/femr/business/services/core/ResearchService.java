...
import femr.util.filters.ResearchFilter;
...
//        }
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            if (filters.getSecondaryDataset() != null) {
                buildSecondaryData(filters, resultSet, resultItem, patient, encounter);
            }
    ...
    private void buildSecondaryData(ResearchFilterItem filters,
                                                  ResearchResultSetItem resultSet,
                                                  ResearchResultItem resultItem,
                                                  IPatient patient,
                                                  IResearchEncounter encounter) {
